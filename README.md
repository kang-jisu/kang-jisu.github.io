...
<img alt="login" src="image/login.png" width="197" ><img alt="feed" src="image/feed.png" width="300"><img alt="mobile" src="image/mobilefeed.png" width="117">

- github : [jeju-instagram](https://github.com/kang-jisu/jeju-instagram-frontend)
- 구현 : 게시글 작성, 수정, 삭제, 회원가입, 로그인 , 반응형 제작
- 관련 기술 : `React`, `reactstrap`, `json-server`, 함수형 컴포넌트, `Hook`, `hoc`
  <br>⠀⠀⠀
